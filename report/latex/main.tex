...
\begin{table}[h]
  ...
  \begin{tabular}{p{3.4cm}p{2.0cm}p{8.3cm}}
    ...
    Do Tuan Minh & 20261057M &
      Team lead and final integration. Defined the code structure and the experiment
      table format; wrote the Introduction (\S1) and Problem Formulation (\S2);
      performed final editing and quality control of the full report; assembled the
      LaTeX/PDF and the GitHub repository. \\
    \addlinespace
