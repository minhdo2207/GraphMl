...
\author{%
  ...
  \AND
  Do Tuan Minh (20261057M) \quad Tran Tien Dung (20252574M) \quad
  Tran Manh Tien (20252762M) \\
  Hoang Huy Chien (20261069M) \quad Nguyen Tien Duc (20252076M)
}
...
\textbf{Do Tuan Minh}: integration, introduction \& problem formulation, report
editing. \textbf{Tran Tien Dung}: dataset pipeline, MLP/GCN baselines.
\textbf{Tran Manh Tien}: GraphSAGE/GAT and architecture comparison.
\textbf{Hoang Huy Chien}: proposed model and ablation.
\textbf{Nguyen Tien Duc}: figures, result analysis, discussion \& limitations.
